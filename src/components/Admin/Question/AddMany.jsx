...
import EditableTable_two from "../../../references/editabletable_2";
    ...
    <PageContainer>
      ...
      >
        ...
        <CardsContainer>
          ...
          <CardStyled>
            ...
            <InstructionsList>
              ...
              <li>Click "Submit" to finalize adding Questions.</li>
            </InstructionsList>
          </CardStyled>
        </CardsContainer>
        <h6
        ...
        <div style={{ overflowX: "auto" }}>
          <TableContainer>
            <EditableTable_two /> {/* Use the EditableTable component */}
          </TableContainer>
        </div>
